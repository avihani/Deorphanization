...
#Open the data files
input_odor_desc_wide <- read.delim("./../ohe_features/optimized_desc_svc_ohe_75.csv", sep=',', header=T, row.names = 1)
input_odor_resp_wide <- read.delim("./../compiled_desc_resp/compiled_odor_sigResp_wide.csv", sep=',', header=T, row.names = 1)
shuffled_odor_desc_wide <- read.delim("./../ohe_features/shuffle_optimized_desc_svc_ohe_75.csv", sep=',', header=T, row.names = 1)
...
#write.csv(shuffled_odor_desc_wide, "./ohe_features/shuffle_optimized_desc_svc_ohe_75.csv")
...
saveRDS(lambdaArray_out, "./../ohe_features/rr_odorCV_preds_all_metrics_75.rds")
saveRDS(regression_model_Euc, "./../ohe_features/rr_odorCV_Euc_models_75.rds")
saveRDS(regression_model_cor, "./../ohe_features/rr_odorCV_cor_models_75.rds")
saveRDS(regression_model_cos, "./../ohe_features/rr_odorCV_cos_models_75.rds")
