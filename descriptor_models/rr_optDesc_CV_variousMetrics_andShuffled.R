...
input_odor_descs_wide <- read.delim("./../compiled_desc_resp/well_predicted_desc.csv", sep=',', header=T, row.names = 1)
#Sort data
...
write.csv(shuffled_odor_descs_wide, "./../compiled_desc_resp/shuffled_filtered_tested_optDesc.csv")
...
saveRDS(lambdaArray_out, "./RR_odorCV_predictions_all_metrics.rds")
saveRDS(regression_model_Euc, "./RR_odorCV_Euc_models.rds")
saveRDS(regression_model_cor, "./RR_odorCV_cor_models.rds")
saveRDS(regression_model_cos, "./RR_odorCV_cos_models.rds")
